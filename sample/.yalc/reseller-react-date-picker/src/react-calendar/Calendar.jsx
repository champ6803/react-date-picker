...
function getDetailValue({
  ...
  console.log(value, minDate, maxDate, maxDetail);
...
function getActiveStartDate(props) {
  ...
  console.log(rangeType, valueFrom);
...
function getInitialActiveStartDate(props) {
  ...
  console.log('call getInitialActiveStartDate');
  const rangeType = getView(view, minDetail, maxDetail);
  const valueFrom = activeStartDate || defaultActiveStartDate;
  console.log(valueFrom, '######3');
  if (valueFrom) {
    return getBegin(rangeType, valueFrom);
  }
...
export default class Calendar extends Component {
  ...
  setStateAndCallCallbacks = (nextState, event, callback) => {
    ...
    const { activeStartDate, ...updateState } = nextState;
